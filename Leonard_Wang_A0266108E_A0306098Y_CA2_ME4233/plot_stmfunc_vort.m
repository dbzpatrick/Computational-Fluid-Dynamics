function [] = plot_stmfunc_vort(stmfunc,vort,Nx,Ny,dx,dy,x,y,x2,y2, t)
...
axis equal
set(gca,'FontSize',40)
title('Streamfunction at the final timestep (Explicit)')
...
axis equal  
set(gca,'FontSize',40)
title('Vorticity at the final timestep (Explicit)')
